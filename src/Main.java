...
public class Main extends JFrame {
	...
	public static void initialize() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Îøèáêà èíèöèàëèçàöèè: " + e.getMessage());
		}
	...
	private static void addUnit(String title, String group) {
		if(groups.contains(group)) {
			...
			throw new IllegalArgumentException("Íåñóùåñòâóþùàÿ ãðóïïà îòâåòà " + group);
		}
	}
			...
			public void actionPerformed(ActionEvent e) {
				for(PlayComponent pc : playComponents) {
					...
					if(rightAnswer.equals(answer)) {
						...
						System.out.println("ÿ ïîìåíÿë öâåò " + pc.getTitle() + " íà çåë¸íûé");
					} else {
